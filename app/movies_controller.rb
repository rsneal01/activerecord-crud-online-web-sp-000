...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  find_by_attributes = Movie.find_by title: "Title", release_date: 2000, director: "Me"
end
...
def can_find_using_where_clause_and_be_sorted
  ...
  movies_by_release_date = Movie.where("release_date > 2002").order(release_date: :desc)
